  ...
  render() {
    ...
    if (config.i18n) {
      ...
      rightContent.unshift(
        <Menu
          ...
          mode="horizontal"
        >
          <SubMenu  key="language" title={<Avatar size="small" src={currentLanguage.flag} />}>
            {languages.map(item => (
    ...
    rightContent.unshift(
      <Popover
        ...
        getPopupContainer={() => document.querySelector('#primaryLayout') as any}
        content={
