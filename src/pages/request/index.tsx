...
let uuid = 2
class RequestPage extends React.Component<RequestPageProps, RequestPageState> {
  ...
  handleClickListItem = ({ method, url }: AxiosRequestConfig) => {
    this.setState({
      method,
      url,
      keys: [uuid++],
            ...
            <List
              ...
              renderItem={item => (
                <List.Item
                  ...
                  onClick={this.handleClickListItem.bind(this, item as any)}
                >
                  <span style={{ width: 72 }}>
                    <Tag
                      style={{ marginRight: 8 }}
